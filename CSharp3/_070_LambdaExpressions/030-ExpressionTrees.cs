...
namespace CSharp3._070_LambdaExpressions
{
    ...
    public class ExpressionTrees
    {
        ...
        public void LambdasMayBeCompiledToExpressionTrees()
        {
            ...
            Assert.That(doubleExpression.Parameters.Single().Type, Is.EqualTo(typeof(Int32)));
            Assert.That(doubleExpression.Body.NodeType, Is.EqualTo(ExpressionType.Multiply));
            Assert.That(doubleExpression.Body.Type, Is.EqualTo(typeof(Int32)));

            Assert.That(doubleExpression.ToString(), Is.EqualTo("param => (param * 2)"));
        }
